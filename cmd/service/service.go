...
import (
	...
	http "github.com/wendellliu/good_search/pkg/http"
...
var fs = flag.NewFlagSet("good-search", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "good-search")
